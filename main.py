    ...
    for a  in list:
        ...
        if m < 10:
            if int(days[counter]) < 10:
                urlretrieve(pic, 'C:\\Users\\Rachu\\FilesforBot\\parser2\\' +'0'+ str(m) + '-' + '0' + days[counter] + pic[chars:])
            else:
                urlretrieve(pic, 'C:\\Users\\Rachu\\FilesforBot\\parser2\\' + '0' + str(m) + '-' + days[counter] + pic[chars:])
        else:
            if int(days[counter]) < 10:
                urlretrieve(pic,
                            'C:\\Users\\Rachu\\FilesforBot\\parser2\\' + str(m) + '-' + '0' + days[counter] + pic[chars:])
            else:
                urlretrieve(pic,
                            'C:\\Users\\Rachu\\FilesforBot\\parser2\\' + str(m) + '-' + days[counter] + pic[chars:])
        counter = counter + 1
